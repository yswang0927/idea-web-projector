...
# yswang modify: $IDE_HOME
[ -z "$IDE_HOME" ] && IDE_HOME=$(dirname "${IDE_BIN_HOME}")
...
"$JAVA_BIN" \
  ...
  -DIDE_HOME=${IDE_HOME} -Djava.system.class.loader=com.intellij.util.lang.PathClassLoader -Didea.vendor.name=JetBrains -Didea.paths.selector=IdeaIC2021.3 -Didea.platform.prefix=Idea -Didea.jre.check=true -Dsplash=true \
